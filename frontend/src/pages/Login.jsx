  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-black p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900/40 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm">Enter the coding universe</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative flex">
                    <input
                      ...
                      } rounded-l-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all`}
                      {...register('password')}
                    />
                    <button
                      type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-cyan-600/25 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
              >
                {/* Shimmer effect */}
        ...
        <div className="absolute -top-6 -right-6 text-gray-700 font-mono text-sm">
          &lt;Login/&gt;
        </div>
        <div className="absolute -bottom-6 -left-6 text-gray-700 font-mono text-sm">
          {`{auth:true}`}
        </div>
      </div>
    </div>
